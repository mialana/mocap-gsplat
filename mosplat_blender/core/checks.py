...
def check_frame_range_poll_result(
    ...
    if end >= props.media_io_accessor.min_frame_count:
        prop_name = props.media_io_accessor._meta.min_frame_count.name
        count = props.media_io_accessor.min_frame_count
        err_list.append(
